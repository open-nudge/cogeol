...
This policy describes how `cogeol` maintainers
consume third-party packages.

## Scope

This policy applies to all `cogeol` maintainers
and all third-party packages used in the `cogeol`
project.

## Policy

`cogeol` contributors must follow these guidelines
...
When adding a new third-party package to `cogeol`,
